                        ...
                        <div class="body">
                            ...
                            <div class="vote__rate mt-2 p-2">
                                ...
                                @if($total_vote >= 1)
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped" data-option="{{$choice->poll_answer}}" style="width:{{$percent}}%"></div>
                                        <small class="option-name">{{$choice->poll_answer}}</small>
                                        <small class="option-percent">{{e_to_b_int(Percent($total_vote, $ans_count))}}%</small>
                                    </div>    
                                    @endforeach
                                    <div class="total-vote d-none">মোট ভোটদাতাঃ {{e_to_b_int($total_vote)}} জন</div>
                                @elseif($total_vote == 0)  
                                <div class="progress">
                                    <div class="progress-bar progress-bar-striped" data-option="হ্যাঁ" style="width:0%"></div>
                                    <small class="option-name">হ্যাঁ</small>
                                    <small class="option-percent">০%</small>
                                </div> 
                                <div class="progress">
                                    <div class="progress-bar progress-bar-striped" data-option="না" style="width:0%"></div>
                                    <small class="option-name">না</small>
                                    <small class="option-percent">০%</small>
                                </div> 
                                <div class="progress">
                                    <div class="progress-bar progress-bar-striped" data-option="মন্তব্য নেই" style="width:0%"></div>
