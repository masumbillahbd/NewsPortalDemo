...
@section('meta_info')
    ...
    <meta name="twitter:url" content="{{ video_url($video) }}">
    <meta name="twitter:title" content="{{ $video->title }}">
    <meta name="twitter:description" content="{{ video_url($video) }}">
    <meta name="twitter:image" content="{{ $video->thumbnail }}">
    <meta property="ia:markup_url" content="{{ video_url($video) }}"/>
    <meta property="ia:markup_url_dev" content="{{ video_url($video) }}"/>
    <meta property="ia:rules_url" content="{{ video_url($video) }}"/>
    <meta property="ia:rules_url_dev" content="{{ video_url($video) }}"/>
    <meta itemscope itemtype="{{ video_url($video) }}"/>
    <link rel="canonical" href="{{ video_url($video) }}">
    <link rel="amphtml" href="{{ video_url($video) }}">
@endsection
@section('extra_css')
    <style>
...
@section('main_content')
    <section class="single__video__page">
        <div class="single_page ads ads__top__banner">
            <div class="container">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="share-btn w-100 pt-4 my-5 d-flex">
                        ...
                        <div class="addthis_inline_share_toolbox" style="width: 58%; float:  left"></div>
                    </div>
                    <div class="comment">
                ...
                <div class="col-md-3 mt-3">
                    <div class="ads ads_6 ads__mbl mb-4" align="center">
                        <span>বিজ্ঞাপন</span>
                        <img src="/photos/5/818d5020-6a1e-44c7-a857-732f05234915.jpg" class="img-responsive">
                    </div>
