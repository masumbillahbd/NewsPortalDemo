...
<head>
    ...
    <!-- important -->
    <link href="{{ asset('/back/css/de.css') }}" rel="stylesheet"> <!-- SB Admin v6.0.2 -->
    <link href="{{ asset('/back/boot4.min.css') }}" rel="stylesheet"/> <!-- Bootstrap v4.0.0  -->
                    ...
                    <div class="tab-content">
                            ...
                            <div class="panel-body">
                                <form method="POST" enctype="multipart/form-data" id="image-upload"
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary submitButton_101" id="submit">Submit
                                            </button>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="tab-pane" id="allMedia" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="pb-1" id="realtimedata" style="text-align:center;"></div>
