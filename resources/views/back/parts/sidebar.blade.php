    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background: ;">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <div class="collapse {{ $route=='popup.index'||$route=='popup.edit'|| $route=='prayertime.index' || $route=='banner.index' ||$route=='innerAd.edit' || $route=='banner.edit' ||$route=='general_setting.index' || $route=='ad.index' || $route=='innerAd.index' || $route=='ad.edit' || $route=='page.index' || $route=='page.create' || $route=='page.edit' || $route=='slider.create' || $route=='slider.edit' || $route=='slider.index'|| $route=='ramadan.create'|| $route=='ramadan.edit' ?'show':''}}" id="collapseSiteSetup" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                ...
                <div class="collapse {{ $route=='loginReport'||$route=='logoutReport'||$route=='userPostCountByDate'||$route=='user.post.report' || $route=='user.post.by.date' || $route=='pageviewreport'|| $route=='date.wise.view'?'show':''}}" id="collapseReport" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="{{ route('loginReport') }}"><i class="fa fa-genderless"></i>Login info</a>
                        <a class="nav-link" href="{{ route('logoutReport') }}"><i class="fa fa-genderless"></i>Logout info</a>
                    </nav>
                </div>
                @endif
