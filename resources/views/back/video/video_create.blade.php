        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card shadow-lg border-0 rounded-lg mt-5 mb-5">
                    <div class="card-header"><h4 class="text-center font-weight-light my-2">Create Video</h4></div>
                    <div class="card-body">
                        <form role="form" method="post" action="{{ route('video.store') }}" >
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="title">Title</label>
                                <input type="text" id="title" name="title" class="form-control" maxlenght="250" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <input name="streaming_site" id="streaming_site" maxlenght="250" type="text" placeholder="facebook or youtube" class="form-control">
                            </div>
                            <div class="form-group">
