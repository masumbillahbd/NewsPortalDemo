         ...
         <div class="col-lg-12">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input id="featured_image" class="form-control" type="text" name="featured_image" maxlenght="250" value="{{$photo->featured_image}}">
                    <span class="input-group-btn"> <a id="feature_lfm" data-input="featured_image" data-preview="holder" class="btn btn-primary btn-height"> <i class="fa fa-image"></i> Choose </a> </span>
                </div>
            </div>
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn"> <a id="lfm{{$body->id}}" data-input="thumbnail{{$body->id}}" data-preview="holder" class="btn btn-primary btn-height"> <i class="fa fa-image"></i> Choose </a> </span>
                            </div>
                        </div>
