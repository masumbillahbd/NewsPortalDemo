    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-6">
        <div class="card shadow-lg border-0 rounded-lg mt-4 mb-3">
          <div class="card-header"><h4 class="text-center font-weight-normal  my-1">Change Password</h4></div>          
          <div class="card-body">
            <form role="form" method="post" action="{{route('user.password.update')}}" >
              @csrf
              <div class="form-group">
                <label class="form-label" id="togglePassword" for="password">Password <i class="far fa-eye" ></i></label>
                  <input class="form-control" id="password" type="password" minlength="8" name="password" placeholder="Password" autocomplete="off">
                  <span class="text-danger">{{ $errors->has('password') ? $errors->first('password'):''}}</span>
              </div>

              <div class="form-group">
                <label class="form-label" id="toggleConfPassword" for="password-confirm" for="password">Confirm Password <i class="far fa-eye" ></i></label>
                  <input class="form-control" id="password-confirm" type="password" minlength="8" name="confirm_password" placeholder="Confirm Password" autocomplete="off">
