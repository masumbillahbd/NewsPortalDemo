...
Route::get('/readmode/edit/{id}',  [ReadMoreController::class, 'edit'])->name('readmore.edit');
...
//color
Route::get('/colors/managers',[ColorController::class, 'index'])->name('color.create');
Route::post('/colors/store',[ColorController::class, 'store'])->name('color.store');
Route::get('/colors/edit/{id}',[ColorController::class, 'edit'])->name('color.edit');
Route::post('/colors/update/{id}',[ColorController::class, 'update'])->name('color.update');
Route::get('/colors/destroy/{id}',[ColorController::class, 'destroy'])->name('color.destroy');
// slider
...
// // Route::get('/customer/create', 'App\Http\Controllers\UserController@customer_create')->name('customer.create');
// Route::post('/customer/store', 'App\Http\Controllers\UserController@customer_store')->name('customer.store');
// Route::get('/customer/edit/{id}', 'App\Http\Controllers\UserController@customer_edit')->name('customer.edit');
// Route::post('/customer/update/{id}', 'App\Http\Controllers\UserController@customer_update')->name('customer.update');
// Route::get('/customer/destroy/{id}', 'App\Http\Controllers\UserController@customer_destroy')->name('customer.destroy');
// ramadan
...
Route::get('/test/destroy/{id}', [TestController::class, 'destroy'])->name('test.destroy');
...
Route::get('video-gallery/gallery/{category}',[FrontendController::class, 'categoryVideoGallery'])->name('category.video.gallery');
Route::get('video-gallery/{id}/{title}',[FrontendController::class, 'singleVideoGallery'])->name('single.video.gallery');
...
Route::get('email-test', function(){
    $details['email'] = 'masumbangla.hw@gmail.com';
    dispatch(new App\Jobs\SendEmailJob($details));
    return view('mail.success-message');
});

Route::get('/photo-gallery', [FrontendController::class, 'photoGallery'])->name('photo.gallery');
Route::get('/{category}/news/{id}',[FrontendController::class, 'singlePost'])->name('single.post');
...
// Route::get('/{category}/{sub_cat}/details/{id}',[FrontendController::class, 'singlePostSubCat'])->name('single.post.sub_cat');
...
//Route::get('/homeCategory28_3/11/11/11/11', [FrontendController::class, 'homeCategory28_3'])->name('homeCategory28_3');
...
Route::get('/info/{slug}', [FrontendController::class, 'singlePage'])->name('single.page');
...
Route::post('newsPopupStatus', [FrontendController::class, 'newsPopupStatus'])->name('newsPopupStatus');
